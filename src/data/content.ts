...
export const SPD: Record<'vi' | 'en', SelectedProject[]> = {
  vi: [
    ...
    },
    {
      ...
      bg: 'Vận hành nội dung và hoạt động truyền thông cho Khu đô thị Sala và THISO Mall Sala, với nhiều nhóm nội dung, kênh truyền thông và đầu mối phối hợp.',
      prob: 'Duy trì tiến độ triển khai và tính nhất quán của nội dung giữa các kênh, đồng thời đảm bảo phối hợp hiệu quả giữa nội bộ, agency và các bên liên quan.',
      roleB: ['Lập kế hoạch và điều phối nội dung theo từng campaign', 'Xây dựng content calendar và quản lý timeline triển khai', 'Brief và phối hợp với Designer, Video Editor, Agency', 'Theo dõi hiệu quả nội dung và tổng hợp báo cáo', 'Phát triển creative concept cho hoạt động cộng đồng & brand activation'],
      steps: ['Lên ý tưởng', 'Lên yêu cầu', 'Sản xuất', 'Phân phối', 'Báo cáo', 'Tối ưu'],
      outs: ['Phối hợp triển khai các chiến dịch và hoạt động của các nhãn hàng theo kế hoạch tại Trung tâm thương mại', 'Duy trì nội dung nhất quán trên social, website, email và các ấn phẩm truyền thông', 'Theo dõi phản hồi và hiệu quả nội dung để điều chỉnh kế hoạch triển khai'],
      mets: [{ v: '16+', l: 'Chiến dịch & hoạt động nhãn hàng' }, { v: '4+', l: 'Kênh truyền thông' }, { v: '200+', l: 'Nội dung & ấn phẩm' }, { v: '100+', l: 'Đơn vị nhãn hàng' }],
      short: 'Vận hành nội dung & activation đa kênh cho retail — THISO Mall Sala, Khu đô thị Sala.',
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      bg: 'Managed content and communications for Sala Urban Area and THISO Mall Sala, spanning multiple content teams, communication channels and coordination touchpoints.',
      prob: 'Keeping execution on schedule and content consistent across channels, while ensuring effective coordination between internal teams, agencies and stakeholders.',
      roleB: ['Planning and coordinating content for each campaign', 'Building content calendars and managing rollout timelines', 'Briefing and coordinating with Designers, Video Editors and Agencies', 'Tracking content performance and consolidating reports', 'Developing creative concepts for community activities & brand activations'],
      steps: ['Content Idea', 'Brief', 'Production', 'Distribution', 'Reporting', 'Optimization'],
      outs: ['Coordinated execution of tenant brand campaigns and activities on schedule at the mall', 'Maintained consistent content across social, website, email and communication assets', 'Tracked feedback and content performance to refine execution plans'],
      mets: [{ v: '16+', l: 'Brand campaigns & activities' }, { v: '4+', l: 'Communication channels' }, { v: '200+', l: 'Content & assets produced' }, { v: '100+', l: 'Brand partners' }],
      short: 'Multi-channel retail content & activation ops — THISO Mall Sala, Sala Urban Area.',
    },
    {
